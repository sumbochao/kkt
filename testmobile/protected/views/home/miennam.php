...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var datetime = currentdate.getFullYear() + "/" + (currentdate.getMonth()+1)  + "/" + (currentdate.getDate()) + " 16:15:00";
...
<div class="bg_white m-t-10 shadow">    
    ...
    <div class="titleXSMN">
        ...
        <p>Đang chờ<span class="red"> KQXS Miền Nam</span> lúc 16h15 - <?php echo date('d/m/Y'); ?>. Còn <span class="count"></span></p>
    </div>
