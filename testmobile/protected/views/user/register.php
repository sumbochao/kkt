...
<script type="text/javascript">
    ...
    function register(){
        ...
        var url = "<?=$url->createUrl('user/register');?>";
        $.ajax({
            type: "POST",
            url: url,
            global: false,
...
<div class="bg_white shadow m-t-10">
    ...
    <div class="SM">
        <div class="searchSM">
            <input id="username" type="text" placeholder="Tên Đăng Nhập" size="5" maxlength="100" class="boxsearchSM"/>
        </div>
        </br>
        <div class="searchSM">
            <input id="password" type="text" placeholder="Mật Khẩu" size="5" maxlength="100" class="boxsearchSM"/>
        </div>
        </br>
        <div class="searchSM">
        ...
        <div class="searchSM">
            <input id="mobile" type="text" placeholder="Số Điện Thoại" size="5" maxlength="100" class="boxsearchSM"/>
        </div>
        </br>
        ...
        <div class="searchSM" id="bongda" style="display: none;">
            <div class="avaImage">
        ...
        <center>
            <div style="margin:20px 0 20px 0;">
                <a href="javascript:void(0);" onclick="register();" class="button_KQ_1">Đăng ký</a>
                &nbsp;&nbsp;
                <a href="javascript:void(0);" onclick="" class="button_KQ_2">Quay lại</a>
            </div>
        </center>
        </br>
    </div>
