...
serviceNameLo="app_thread"                                  # service name with the first letter in lowercase
serviceName="AppThreads"                                    # service name
serviceUser="root"                                      # OS user name for the service
serviceGroup="root"                                    # OS group name for the service
applDir="/data/website/taoviec/taoviec.com/java_cront/app"                          # home directory of the service application
serviceUserHome="/data/website/taoviec/taoviec.com/java_cront/app/$serviceUser"                       # home directory of the service user
serviceLogFile="/data/website/taoviec/taoviec.com/java_cront/app/log/$serviceNameLo.log"               # log file for StdOut/StdErr
maxShutdownTime=15                                         # maximum number of seconds to wait for the daemon to terminate normally
pidFile="/data/website/taoviec/taoviec.com/java_cront/app/$serviceNameLo.pid"                      # name of PID file (PID = process ID number)
