...
serviceNameLo="game_thread"                                  # service name with the first letter in lowercase
serviceName="GameThreads"                                    # service name
serviceUser="root"                                      # OS user name for the service
serviceGroup="root"                                    # OS group name for the service
applDir="/data/website/taoviec/taoviec.com/java_cront/game"                          # home directory of the service application
serviceUserHome="/data/website/taoviec/taoviec.com/java_cront/game/$serviceUser"                       # home directory of the service user
serviceLogFile="/data/website/taoviec/taoviec.com/java_cront/game/log/$serviceNameLo.log"               # log file for StdOut/StdErr
maxShutdownTime=15                                         # maximum number of seconds to wait for the daemon to terminate normally
pidFile="/data/website/taoviec/taoviec.com/java_cront/game/$serviceNameLo.pid"                      # name of PID file (PID = process ID number)
javaJar="com.hdc.wapcontent.generator.jar"
javaCommand="java"                                         # name of the Java launcher without the path
javaExe="java"                      # file name of the Java application launcher executable
javaArgs=" -jar $applDir/$javaJar"                     # arguments for Java launcher
javaCommandLine="$javaExe $javaArgs"                       # command line to start the Java service application
javaCommandLineKeyword="$javaJar"                     # a keyword that occurs on the commandline, used to detect an already running service process and to distinguish it from others
