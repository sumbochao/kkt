<?php
require '/home/kktien/domains/kenhkiemtien.com/public_html/kenhkiemtien.com/fb/src/facebook.php';
require 'AdvFacebookDAO.php';
// Create an Application instance (replace with your appId and secret).
$app_id = "264501217006830";$app_secret="9789f7ef545619bc2b87faf04399ca49";
...
if ($user) {
        ...
        $friends_list      = $facebook->api('/me/invitable_friends?limit=5000');
...
echo "Insert ID Friends:";
        echo '<ul>';
            foreach ($friends_list["data"] as $value) {
			   ...
			   echo '<div class="picName">'.$value["picture"]["data"]["url"].'<br></div>'; 
			   $pieces = explode("_", $value["picture"]["data"]["url"]);
               echo $pieces["1"];
