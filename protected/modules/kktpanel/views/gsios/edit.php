...
<script type="text/javascript">
    function ajaxUpdate(){
        //alert('test');
        var strUrl = "<?=$url->createUrl('gsios/ajaxUpdate')?>";
        var id = "<?php echo $id?>"
        var title = $('#title').val();
        ...
        $.ajax({
            ...
            success: function(msg){
                if(msg == 1){
                    ...
                    window.location = '<?php echo $url->createUrl("gsios/index")?>';
                }else{
                    alert('Có lỗi');
                    $("#show_error").html(msg);
                }
        ...
        <div clas = "box">
            <ul class="form">
                ...
                <li class="clearfix"><label><strong>URL </strong>:</label>
                    <div class="filltext">
                        <input type="text" style="width:360px" value="<?php echo $data['url']?>" id="url"> 
                    </div>
                </li>
