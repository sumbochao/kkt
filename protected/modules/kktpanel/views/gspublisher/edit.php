...
<script type="text/javascript">
    ...
    function ajaxUpdate(){
        var strUrl = "<?=$url->createUrl("gspublisher/ajaxUpdate") ?>";
    ...
    <div class="box clearfix bottom30">
        <ul class="form4">
            <li class="clearfix"><label><strong>Tên danh mục </strong>:</label>
                <div class="filltext">
                    <input type="text" style="width:360px" value="<?php echo $data['name'];?>" id="name_pub"> 
                </div>
            </li>
            ...
            <li class="clearfix"><label><strong>Ảnh minh họa </strong>:</label>
                <div class="filltext">
                    ...
                    <p id="show_pic">
                        <?php if($data['image']!=""){?>
                            <img src="<?php echo Yii::app()->params['urlImages'];?>/gamestore/publisher/<?php echo date('Y/md',strtotime($data['create_date']))?>/<?php echo $data['image'];?>" style="width: 100px;height:100;">
                            <?php }?>
                    </p>
                </div>
            </li>
