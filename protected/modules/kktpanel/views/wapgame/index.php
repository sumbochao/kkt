...
<script type="text/javascript">
    function ajaxQuickUpdate(id){
        ...
        var strUrl = "<?=$url->createUrl("wapgame/ajaxQuickUpdate") ?>";
        $.ajax({
            type: "POST",
            url: strUrl,
            data: {
    ...
    function ajaxDelete(id){
        var strUrl = "<?=$url->createUrl("wapgame/ajaxDelete") ?>";
                 ...
                 <li class="clearfix"><label><strong>Tìm kiếm theo</strong>:</label>
                    <div class="filltext">
                        <select style="width:203px;" name="orderBy">
                            ...
                            <option value="0" <?php echo ($orderBy == 0 ? 'selected="selected"':'' )?>>Download Jar</option>
    ...
    <div class="box">
        <div class="fillter clearfix">
            <div class="fl">
                ...
                <a href="<?php echo $url->createUrl("wapgame/create")?>"><input type="button" class="btn-bigblue" value=" Thêm mới "></a>
            </div>
            <div class="fr">
                <ul class="paging">
                    <?php
                ...
                <tbody>
                    ...
                    <?php foreach($data as $key=>$value){$key+=1;?>
                        <tr>
                            ...
                            <td><img style="width: 75px; height: 75px;" src="<?php echo Common::getImage($value["image"],"wapgame",$value["create_date"])?>" /></td>
                            <td>
                                <?php 
                                    $x="";
                            ...
                            <td>
                                ...
                                <a href="<?php echo $url->createUrl("wapgame/edit",array("id"=>$value["id"]))?>"> Sửa </a> | 
