...
<script type="text/javascript">
    ...
    function ajaxSaveAudio(){
        ...
        var strUrl = "<?=$url->createUrl("audio/ajaxSaveAudio") ?>";
        $.ajax({
            type: "POST",
            url: strUrl,
            data: {
            ...
            <div clas = "box">
                <ul class="form">
                    <li class="clearfix"><label><strong>Tên Audio </strong>:</label>
                        <div class="filltext">
                            <input type="text" style="width:360px" value="" id="title_audio"> 
                        </div>
                    </li>
                    ...
                    <li class="clearfix"><label><strong>Người đọc </strong>:</label>
                        <div class="filltext">
                            <input type="text" style="width:360px" value="" id="reader"> 
                        </div>
                    </li>
                    ...
                    <li class="clearfix"><label><strong>Số chương</strong>:</label>
                        <div class="filltext">
                            <input type="text" id="chapter" name="chapter" style="border:1px solid #DFDFDF; width: 80px;"/> 
                        </div>
                    </li>
                    ...
                    <li class="clearfix"><label>&nbsp;</label>
                        <div class="filltext">
                            <input id="button_save" onclick="ajaxSaveAudio();" type="button" value=" Thêm mới " class="btn-bigblue"> 
                            &nbsp;
