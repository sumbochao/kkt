...
<div class="main clearfix">
    ...
    <div clas = "box">
      <form name="banCharFrm" id="banCharFrm" name="banCommentFrm" action="<?php echo $url->createUrl("gsuser/excBanChat",array());?>" method="post">
        ...
        <ul class="form">
            ...
            <li class="clearfix"><label><strong>Lý do </strong>:</label>
                <div class="filltext">
                    ...
                    <input type="radio" value="2" name="reason"> &nbsp; Nội dung chát không phù hợp
                </div>
            </li>
