...
<script type="text/javascript">
    function ajaxQuickUpdate(id){
        ...
        var strUrl = "<?=$url->createUrl("gamelao/ajaxQuickUpdate") ?>";
        $.ajax({
            type: "POST",
            url: strUrl,
            data: {
    ...
    function ajaxDelete(id){
        var strUrl = "<?=$url->createUrl("gamelao/ajaxDelete") ?>";
...
<div class="main clearfix">
                ...
                <li class="clearfix">
                    ...
                    <div class="filltext">
                        <select style="width:203px;" name="orderBy">
                            ...
                            <option value="1" <?php echo ($orderBy == 1 ? 'selected="selected"':'' )?>>Download Jar</option>
                            <option value="2" <?php echo ($orderBy == 2 ? 'selected="selected"':'' )?>>Download Apk</option>
                            <option value="3" <?php echo ($orderBy == 3 ? 'selected="selected"':'' )?>>Download Ipa</option>
                        </select>
                        &nbsp; Sắp xếp &nbsp;&nbsp;&nbsp;
    ...
    <div class="box">
        <div class="filler clearfix">

            <div class="fl">
                Tìm thấy <strong class="clred"></strong> kết quả - 
                <a href="<?php echo $url->createUrl('gamelao/create');?>">
                    <input type="button" class="btn-bigblue" value="Thêm mới">
                </a>
            </div>
            ...
            <tbody>
                ...
                <?php foreach($data as $key=>$value){$key+=1;?>
                    <tr>
                        ...
                        <td><img style="width: 75px; height: 75px;" src="<?php echo Common::getImage($value["image"],"gamelao",$value["create_date"])?>" /></td>
                        <td><?php echo $data_cat[$value["cat_id"]];?></td>
                        ...
                        <td>
                            ...
                            <a href="<?php echo $url->createUrl("gamelao/edit",array("id"=>$value["id"]))?>"> Sửa </a> | 
