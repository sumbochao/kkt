...
<script type="text/javascript">
    ...
    function ajaxUpdateApp(){
        var strUrl = "<?php echo $url->createUrl("app/ajaxUpdateApp") ?>";
        ...
        <ul class="form4">
            ...
            <li class="clearfix"><label><strong>Ảnh minh họa </strong>:</label>
                <div class="filltext">
                    ...
                    Ảnh vuông: <p id="show_pic"><img class="img-100" src="<?php echo Common::getImage($data["picture"],"app",$data["create_date"])?>"/></p>
