    ...
    <div class="main clearfix">
        ...
        <div class="box clearfix bottom30">
            <form action="" method="POST">
                <ul class="form4">
                    <div class="title-blue"><h3><strong>Tỷ lệ thuê đầu số</strong></h3></div>
                    <?php foreach($rate as $row) { ?>                    
                    <li class="clearfix"><label><strong>Định mức: <?php echo Common::format_price($row["money"]);?></strong></label>
                        <div class="filltext">
                            <input type="text" style="width:200px" name="<?php echo $row["id"];?>" value="<?php echo $row["rate_of_service_code"];?>"> 
                        </div>
                    </li>
                    <?php }?>
