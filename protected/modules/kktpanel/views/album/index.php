...
<script type="text/javascript">
    function ajaxQuickUpdate(id){
        ...
        var strUrl = "<?=$url->createUrl("album/ajaxQuickUpdate") ?>";
        $.ajax({
            type: "POST",
            url: strUrl,
            data: {
    ...
    function ajaxDelete(id){
        var strUrl = "<?=$url->createUrl("album/ajaxDelete") ?>";
    ...
    <div class="box">
        <div class="fillter clearfix">
            <div class="fl">
                ...
                <a href="<?php echo $url->createUrl("album/create")?>"><input type="button" class="btn-bigblue" value=" Thêm mới "></a>
            </div>
            <div class="fr">
                <ul class="paging">
                    <?php
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                    <tr class="bg-grey">
                        ...
                        <td width="6%"><strong>Lượt xem</strong></td>
                        <td width="6%"><strong>Lượt tải</strong></td>
                        <td width="8%"><strong>Trạng thái</strong></td>
                        <td width="6%"><strong>Nổi bật</strong></td>
                        <td width="6%"><strong>Show Home</strong></td>
                        <td width="6%"><strong>Hot App</strong></td>
                    ...
                    foreach($data as $key=>$value){
                        ...
                        <tr>
                            ...
                            <td><img style="width: 100px; height: 100px;" src="<?php echo Common::getImage($value["picture"],"image",$value["create_date"])?>" /></td>
                            ...
                            <a href="<?php echo $url->createUrl("album/edit",array("id"=>$value["id"]))?>"> Sửa </a> | 
                            <a href="javascript:void(0)" onclick="ajaxDelete('<?php echo $value["id"]?>')">  Xóa  </a> | 
                            <a href="<?php echo $url->createUrl("album/image",array("albumId"=>$value["id"]))?>">  Xem  </a> | 
                            <a href="<?php echo $url->createUrl("seo/detail",array("id"=>$value["id"],"type"=>3))?>"> SEO </a> 
                            </td>
                        </tr>
                        <?php }?>
                </tbody>
