...
<script type="text/javascript">
    ...
    function uploadResponse(serverData){  
        try {
            ...
            $("#show_pic").html('<img src="<?php echo Yii::app()->params["urlImages"].$forder_upload.'/';?>'+path +'/'+ filename +'" style="100px" alt="pic">');
    ...
    function ajaxSaveCup()
    {
        var strUrl = "<?=$url->createUrl("footBallCup/ajaxSaveCup") ?>";
        var name = $('#name').val();
        ...
        $.ajax({
            ...
            success: function(msg){
                if(msg == 1){
                    ...
                    window.location = '<?php echo $url->createUrl("footBallCup/index")?>';
                }else{
                    $("#show_error").html(msg);
                }
            },
        ...
        <div clas = "box">
            <ul class="form">
                ...
                <li class="clearfix"><label><strong>Châu lục</strong>:</label>
                    <div class="filltext">
                       <input type="text" style="width:360px" value="" id="continent"> 
                    </div>
                </li>
                ...
                <li class="clearfix"><label>&nbsp;</label>
                    <div class="filltext">
                        <input id="button_save" onclick="ajaxSaveCup();" type="button" value=" Thêm mới " class="btn-bigblue"> 
                        &nbsp;
