...
<script type="text/javascript">
    function ajaxQuickUpdate(id){
        ...
        var strUrl = "<?=$url->createUrl("advertise/ajaxQuickUpdate") ?>";
        $.ajax({
            type: "POST",
            url: strUrl,
            data: {
    ...
    function ajaxDelete(id){
        var strUrl = "<?=$url->createUrl("advertise/ajaxDelete") ?>";
        ...
        <form method="GET">
            <ul class="form4">
                ...
                <li class="clearfix"><label><strong>Loại link</strong>:</label>
                    <div class="filltext">
                        <select style="width:203px;" name="dynamic_adv">
                            <option value="2" >- Tất cả -</option> 
                            <?php foreach($dynamic as $key=>$value){?>
                                <option value="<?php echo $key;?>" <?php echo ($dynamic_adv == $key ? 'selected="selected"':'' )?>><?php echo $value?></option>
                                <?php }?>
                        </select>
                    </div>
                </li>
    ...
    <div class="box">
        <div class="fillter clearfix">
            <div class="fl">
                ...
                <a href="<?php echo $url->createUrl("advertise/create")?>"><input type="button" class="btn-bigblue" value=" Thêm mới "></a>
            </div>
            <div class="fr">
                <ul class="paging">
                    <?php
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                    <tr class="bg-grey">
                        ...
                        <td width="10%"><strong>Tiêu đề</strong></td>
                        <td width="8%"><strong>Box Quảng cáo</strong></td>
                        <td width="10%"><strong>Link (Kiểu quảng cáo)</strong></td>                        
                    ...
                    <?php    
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($value["type"]==0){?>
                                    <img src="<?php echo Common::getImage($value["picture"],"banner",$value["create_date"])?>" />
                                    <?php }else{?>
                                    Banner Text
                                    <?php }?>
                            </td>
                            <td><?php echo $value["title"]?></td>
                            <td><?php echo $box[$value['box']];?></td>
                            <td>
                                <?php 
                                    if($value["dynamic"]==0){
                                        echo 'Link tĩnh: '.  $value["link"];
                                    }else{
                                        echo 'Link động: '. $type_content[$value["type_content"]];
                                    }
                                ?>
                            </td>                              
                            ...
                            <td>
                                ...
                                <a href="<?php echo $url->createUrl("advertise/edit",array("id"=>$value["id"]))?>"> Sửa </a> | 
