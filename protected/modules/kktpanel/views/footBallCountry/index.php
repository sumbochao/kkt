...
<script type="text/javascript">
    ...
    function ajaxQuickUpdate(id){
        var strUrl = "<?=$url->createUrl("footBallCountry/ajaxQuickUpdate") ?>";
        var status = 0;
    ...
    function ajaxDelete(id){
        var strUrl = "<?=$url->createUrl("footBallCountry/ajaxDeleteCountry") ?>";
        ...
        <div class="fillter clearfix">
            <div class="fl">
                Tìm thấy <strong class="clred"><?php echo $count; ?></strong> kết quả - 
                    <a href="<?php echo $url->createUrl("footBallCountry/create")?>"><input type="button" class="btn-bigblue" value=" Thêm mới "></a>
            </div>
            <div class="fr">
                <ul class="paging">
                    <?php
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
            <tbody>
                <tr class="bg-grey">
                    ...
                    <td width="15%"><strong>Tên Quốc gia</strong></td>
                    <td width="15%"><strong>Tên Quốc gia En</strong></td> 
                    <td width="20%"><strong>Cờ</strong></td>
                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <?php 
                            if($value['flag']!=""){
                                ?>
                                  <img style="width: 100px" src="<?php echo Yii::app()->params['urlImages']?>bongda/country/<?php echo  date('Y/md', strtotime($value['create_date']))?>/<?php echo $value['flag']?>" />
                                <?php
                            }
                        ?>
                        ...
                        <td>
                            <a href="<?php echo $url->createUrl("footBallCountry/edit",array("id"=>$value["id"],"page"=>$page))?>"> Sửa </a> | 
