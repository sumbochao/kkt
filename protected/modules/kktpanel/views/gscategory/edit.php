<?php
    $url = new Url();
    $forder_upload = "gamestore/category";  
...
<script type="text/javascript">
    ...
    function ajaxUpdate(){
        var strUrl = "<?=$url->createUrl("gscategory/ajaxUpdate") ?>";
        ...
        $.ajax({
            ...
            success: function(msg){
                if(msg == 1){
                    ...
                    window.location = '<?php echo $url->createUrl("gscategory/index")?>';
                }else{
                    $("#show_error").html(msg);
                }
            },
        ...
        <ul class="form4">
            ...
            <li class="clearfix"><label><strong>Ảnh minh họa </strong>:</label>
                <div class="filltext">
                    ...
                    <p id="show_pic">
                        <?php if($data['image']!=""){?>
                            <img src="<?php echo Yii::app()->params['urlImages'];?>/gamestore/category/<?php echo date('Y/md',strtotime($data['create_date']))?>/<?php echo $data['image'];?>" style="width: 100px;">
                        <?php }?>
                    </p>
                </div>
            </li>
             <li class="clearfix"><label><strong>Order View </strong>:</label>
                <div class="filltext">
                    <input type="text" style="width:360px" value="" id="order_view"> 
                </div>
            </li>
