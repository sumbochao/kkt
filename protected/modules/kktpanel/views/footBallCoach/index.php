...
<script type="text/javascript">
    function ajaxDelete(id){
        var strUrl = "<?=$url->createUrl("footBallCoach/ajaxDeleteNews") ?>";
    ...
    function ajaxQuickUpdate(id){
        var strUrl = "<?=$url->createUrl("footBallCoach/ajaxQuickUpdate") ?>";
        var status = 0;
    ...
    <div class="box">
        <div class="fillter clearfix">
            <div class="fl">
                ...
                <a href="<?php echo $url->createUrl("footBallCoach/create")?>"><input type="button" class="btn-bigblue" value=" Thêm mới "></a>
            </div>
            <div class="fr">
                <ul class="paging">
                    <?php
                ...
                <?php foreach($data as $key=>$value){$key+=1;?>
                    <tr>
                        ...
                        <?php 
                            if($value['avatar']!=""){
                        ?>
                                  <img style="width: 50%;" src="<?php echo Yii::app()->params['urlImages']?>bongda/coach/<?php echo  date('Y/md', strtotime($value['create_date']))?>/<?php echo $value['avatar']?>" />
                        ...
                        <td>
                            <a href="<?php echo $url->createUrl("footBallCoach/edit",array("id"=>$value["id"]))?>"> Sửa </a> | 
