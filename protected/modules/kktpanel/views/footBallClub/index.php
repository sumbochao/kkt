...
<script type="text/javascript">
    ...
    function ajaxQuickUpdate(id){
        var strUrl = "<?=$url->createUrl("footBallClub/ajaxQuickUpdate") ?>";
        var status = 0;
        ...
        <div class="fillter clearfix">
            <div class="fl">
                Tìm thấy <strong class="clred"><?php echo $count; ?></strong> kết quả - 
                    <a href="<?php echo $url->createUrl("footBallClub/create")?>"><input type="button" class="btn-bigblue" value=" Thêm mới "></a>
            </div>
            <div class="fr">
                <ul class="paging">
                    <?php
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
            <tbody>
                <tr class="bg-grey">
                    ...
                    <td width="10%"><strong>Mã đội</strong></td>
                    <td width="15%"><strong>Tên đội</strong></td>
                    <td width="15%"><strong>Tên đội En</strong></td>  
                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <?php 
                            if($value['logo']!=""){
                                ?>
                                  <img style="width: 50px;" src="<?php echo Yii::app()->params['urlImages']?>bongda/club/<?php echo  date('Y/md', strtotime($value['create_date']))?>/<?php echo $value['logo']?>" />     
                                 <?php
                            }
                        ?>
                        ...
                        <td>
                            <a href="<?php echo $url->createUrl("footBallClub/edit",array("id"=>$value["id"],"page"=>$page))?>"> Sửa </a> | 
