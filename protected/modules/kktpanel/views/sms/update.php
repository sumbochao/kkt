...
<script type="text/javascript">
        ...
        var strUrl = "<?=$url->createUrl("sms/AjaxUpdate") ?>";
        $.ajax({
            type: "POST",
            url: strUrl,
            data: {
            ...
            <div class="col-570">
                <ul id="form_create" class="form">
                    ...
                    <li class="clearfix">
                        ...
                        <div class="filltext">
                            <textarea id="description" name="description" cols="45" rows="200" style="height: 120px;"><?php echo $row['description'];?></textarea>
                        </div>
                    ...
                    <li class="clearfix">
                        ...
                        <div class="filltext" style="margin-left: 97px;">
                            <input onclick="ajaxUpdateGame();" id="button_save" class="btn-bigblue" type="button" value=" Sửa ">
