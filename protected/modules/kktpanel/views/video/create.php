...
<script type="text/javascript">
    ...
    function ajaxSaveVideo(){
        ...
        var strUrl = "<?=$url->createUrl("video/ajaxSaveVideo") ?>";
        $.ajax({
            type: "POST",
            url: strUrl,
            data: {
            ...
            <div clas = "box">
                <ul class="form">
                    <li class="clearfix"><label><strong>Tên video </strong>:</label>
                        <div class="filltext">
                            <input type="text" style="width:360px" value="" id="title_video"> 
                        </div>
                    </li>
                    ...
                    <li class="clearfix"><label><strong>Thời gian</strong>:</label>
                        <div class="filltext">
                            <input type="text" id="duration" name="duration" style="border:1px solid #DFDFDF; width: 80px;"/> (hh:mm:ss)
                        </div>
                    </li>
                    ...
                    <li class="clearfix"><label><strong>Tóm tắt</strong>:</label>
                        <div class="filltext">
                            <textarea cols="5" rows="5" style="width:420px; height:120px" id="introtext"></textarea>
                        </div>
                    </li>
                ...
                <ul class="form" id="form1">
                    <li id = "li1" style="display: none;" class="clearfix"><label><strong>UploadFile 3Gp</strong></label>
                        <div class="filltext">
                            ...
                            <input type="hidden" id="file_video"/>
                            <p id="show_file"></p>               
                        </div>
                    </li>
                    <li id = "li2" style="display: none;" class="clearfix"><label><strong>UploadFile Mp4</strong></label>
                        <div class="filltext">
                            ...
                            <input type="hidden" id="file_mp4"/>
                            <p id="show_file_mp4"></p>               
                        </div>
                    </li>
                    <fieldset id="field_name" style="width: 535px"><legend><strong>Nhập tên</strong></legend>
                        <li class="clearfix"><label><strong>Tên video 3Gp</strong>:</label>
                            <div class="filltext">
                                <input style="width:360px" type="text" value="" id="filename_video"/>
                            </div>
                        </li>
                        <li class="clearfix"><label><strong>Tên video Mp4</strong>:</label>
                            <div class="filltext">
                                <input style="width:360px" type="text" value="" id="filename_mp4"/>
                            </div>
                        </li>
                    </fieldset> 
                    <br/>
                    <fieldset id="field_link" style="width: 535px;display: none;"><legend><strong>Nhập link</strong></legend> 
                        ...
                        <li class="clearfix"><label><strong>Link video Mp4</strong>:</label>
                            <div class="filltext">
                                <input type="text" style="width:360px" value="" id="link_mp4"> 
                            </div>
                        </li>
                    </fieldset>
                    <br/> 
