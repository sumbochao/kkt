...
<script type="text/javascript">
    ...
    function ajaxUpdate(){
        var strUrl = "<?=$url->createUrl("category/ajaxUpdate") ?>";
        var appId =0;
    ...
    <div class="box clearfix bottom30">
        <ul class="form4">
            <li class="clearfix"><label><strong>Tên danh mục </strong>:</label>
                <div class="filltext">
                    <input type="text" style="width:360px" value="<?php echo $data["name"];?>" id="name_cat"> 
                </div>
            </li>
            <li class="clearfix"><label><strong>Tóm tắt</strong>:</label>
                <div class="filltext">
                    <textarea cols="5" rows="5" style="width:624px; height:120px" id="introtext"><?php echo $data["introtext"];?></textarea>
                </div>
            </li>
                ...
                <div class="filltext">
                    <select style="width:203px;" id="type_cat">
                        <?php foreach($type_cats as $key=>$value){
                            ...
                            ?>
                            <option <?php echo ($key == $data["type"]) ? "selected='selected'" :""; ?> value="<?php echo $key;?>"><?php echo $value?></option>
                            <?php }?>
                    </select>
                </div>
            </li>
            ...
            <li class="clearfix"><label><strong>Thuộc kênh 18</strong>:</label>
                <div class="filltext">
                    <select style="width:203px;" id="isSex">
                        ...
                        <option value="1" <?php echo $data["status"]==1 ? 'selected="selected"':''; ?>>Có</option>
                    </select>
                </div>
            </li>
            <li class="clearfix"><label><strong>Ảnh minh họa </strong>:</label>
                <div class="filltext">
                    ...
                    Ảnh vuông: <p id="show_pic"><img class="img-100" src="<?php echo Common::getImage($data["picture"],"category",$data["create_date"])?>"/></p>
                    <input type="hidden" id="picture_320_240" value="<?php echo $data["picture_320_240"];?>"/>
                    Ảnh 320x240: <p id="show_pic_320_240"><img style="width:320px;height:240px" src="<?php echo Common::getImage($data["picture_320_240"],"category",$data["create_date"])?>"/></p>
                    <input type="hidden" id="picture_240_320" value="<?php echo $data["picture_240_320"];?>"/>
                    Ảnh 240x320: <p id="show_pic_240_320"><img style="width:240px;height:320px" src="<?php echo Common::getImage($data["picture_240_320"],"category",$data["create_date"])?>"/></p>
                </div>
            </li>
            ...
            <li class="clearfix"><label>&nbsp;</label>
                <div class="filltext">
                    <input id="button_save" type="button" value=" Sửa " class="btn-bigblue" onclick="ajaxUpdate();"> 
                    &nbsp;
