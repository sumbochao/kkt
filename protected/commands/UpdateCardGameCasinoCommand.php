<?php
class UpdateCardGameCasinoCommand extends CConsoleCommand
{
    public function run($args)
    {
        $jsonurl = "http://192.168.1.125:7985/getCardServlet?username=59&game_name=2&token=98919a0f99f29c1a7068d548eb2e69dd";
        ...
        echo "Update Date Card Game vua bai Cron Job At ".date("H:i:s - d/m/Y")." \n";
    }
}
?>