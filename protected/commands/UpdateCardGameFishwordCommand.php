<?php
class UpdateCardGameFishwordCommand extends CConsoleCommand
{
    public function run($args)
    {
        $jsonurl = "http://192.168.1.125:7985/getCardServlet?username=59&game_name=3&token=b313d89375dfe0ec7ce1617a2708b531";
        ...
        echo "Update Date Card Game thien duong ca Cron Job At ".date("H:i:s - d/m/Y")." \n";
    }
}
?>