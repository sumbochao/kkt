<?php
class UpdateCardGameThanbaiCommand extends CConsoleCommand
{
    public function run($args)
    {
        $jsonurl = "http://192.168.1.125:7985/getCardServlet?username=59&game_name=5&token=cba1a047fb06c1fe2f97d34ee2cd7c48";
        ...
        echo "Update Date Card Game Than bai Cron Job At ".date("H:i:s - d/m/Y")." \n";
    }
}
?>