    ...
    <div class="main clearfix">
        <div class="box pad10">
            <div class="table">
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                        <tr>
                            <td width="52">
                                <a title="pic" href="<?php echo Url::createUrl("kktUser/myAdvDetail", array("id"=>$adv["id"]));?>">
                                    <img class="img52" src="<?php echo Common::getImage($adv["picture"], "user/" . $username . "/picture", $adv["create_date"], "");?>" />
                                </a>
                            </td>
                            <td class="item_data" valign="top">
                                <a href="<?php echo Url::createUrl("kktUser/myAdvDetail", array("id"=>$adv["id"]));?>"><strong><?php echo $adv["title"];?></strong></a><br />
                                <span class="cl999"><?php echo Common::format_price($adv["download"]);?> lượt tải</span><br />                                
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="link_adv">
                <span>
                    <?php
                        $link_download = "http://" . $_SERVER["HTTP_HOST"] . Url::createUrl("kktDownload/downloadMyAdv", array("alias"=>$adv["alias"], "id"=>$adv["id"]));
            ...
            <div class="mag_btt_t5">
                ...
                <textarea onclick="javascript:select();" style="width: 80%; min-height:50px" readonly><div style="text-align: center;"><a href="<?php echo $link_download;?>"> <?php echo $adv["title"];?> </a></div></textarea>                        
            </div>
            <div class="mag_btt_t5">
                <span>
                    Box di động của bạn: 
