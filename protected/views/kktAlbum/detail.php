    ...
    <div class="main clearfix">
        ...
        <div class="pic_detail">
            <div class="table list_table">
                ...
                $link_img=Common::getImage($detail['picture'],'image',$detail['create_date'],'m');
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        ...
                        <td valign="top" class="item_data nobor">
                            ...
                            <span class="cl999"><?php echo $detail['hit'];?> Lượt xem. <?php echo sizeof($images);?> ảnh</span><br>
        ...
        <div class="list_pic pad10 bor_top">
             <ul class="list_style">
				...
				if($images)
				{
					...
					{
						$link_img=Common::getImage($row['file'],'image',$row['create_date']);
						echo '<li><img width="20%" src="'.$link_img.'"></li>';
						$k++;
						if($k==3) break;
					}
