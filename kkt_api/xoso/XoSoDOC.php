...
class XoSoDOC
{
    ...
    function  getAppHeaderXoSo()
    {
         echo "<h2 style='color:red'>getAppHeaderXoSo:</h2>";
            ...
            echo "</ul>";
            echo "<span>Ví dụ: <a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?action=getAppHeaderXoSo&app_header=XOSO-MARKET-IOS&os_version=6.0&app_client_id=123&imei=124' target='_blank'>Lấy thông số cầu hình của app.</a></span>" ;     
    ...
    function getUserXoSo()
    {
        echo "<h2 style='color:red'>getUserXoSo:</h2>";
            ...
            echo "</ul>";
            echo "<span>Ví dụ: <a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?action=getUserXoSo&user_id=1' target='_blank'>Lấy thông tin user.</a></span>" ;     
    ...
    function getTaiKhoanChinh()
    {
         echo "<h2 style='color:red'>getTaiKhoanChinh:</h2>";
            ...
            echo "<li>user_id: id của user</li>"; 
            echo "</ul>";
            echo "<span>Ví dụ: <a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?action=getTaiKhoanChinh&user_id=1' target='_blank'>Lấy thông tin tài khoản.</a></span>" ; 
    ...
    function updateUser()
    {
          echo "<h2 style='color:red'>updateUser:</h2>";
            ...
            echo "</ul>";
            echo "<span>Ví dụ: <a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?action=updateUser&user_id=123&username=thangtt' target='_blank'>Cap nhat ten tai khoan.</a></span>" ; 
    ...
    function uploadAvatar()
    {
         echo "<h2 style='color:red'>uploadAvatar:</h2>";
            ...
            echo "</ul>";
            echo "<span>Ví dụ: <a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?action=uploadAvatar&user_id=1updateUser' target='_blank'>Cap nhat ten tai khoan.</a></span>" ;  
    ...
    function postChat()
    {
         echo "<h2 style='color:red'>postChat:</h2>";
            ...
            echo "</ul>";
            echo "<span>Ví dụ: <a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?action=postChat&user_id=123' target='_blank'>Post Chat.</a></span>" ;                                
    ...
    function registerMember()
    {
        ...
        echo "<span>Ví dụ: <a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?action=registerMember&app_client_id=123' target='_blank'>Register Member</a></span>" ;
    }
    function postComment()
    {
        echo "<h2 style='color:red'>postComment:</h2>";
            ...
            echo "</ul>";
            echo "<span>Ví dụ: <a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?action=postComment&id_thread=1&id_user=1&fullname=test&comment=alo alo' target='_blank'>Post Comment chủ đề </a></span>" ;
    }
     ...
     function registryNotice(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?action=registryNotice&app_client_id=123&device_token=123ffdf&os_type=2&user_id=1' target='_blank'>registryNotice</a></span>";
    }
}
?>
