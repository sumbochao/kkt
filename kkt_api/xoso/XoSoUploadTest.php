...
?>
Upload File.<br>
<form action="<?php echo $domain?>/kkt_api/xoso/XoSoAPI.php?action=uploadAvatar&user_id=11554" method="post" enctype="multipart/form-data" ><br>
