    ...
    switch($action){
       ...
       case "getTKDauSoMoThuong": {
        ...
        case "postChat": {
            ...
            if(empty($user_id)||empty($content)||empty($deviceName)||$checkContent==1||$checkUser==1) {
                 $arrOut = array();
                 $arrOut["result"]  = 1;
                 echo json_encode($arrOut);
                 return;
        ...
        default:  {
			...
			if (!empty( $function )) {
				...
				echo "<UL>";
                                 echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getAppHeaderXoSo' target='_blank'>getAppHeaderXoSo</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTTKQXS' target='_blank'>getTTKQXS</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getKTXS' target='_blank'>getKTXS</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getKTXSByRegion' target='_blank'>getKTXSByRegion</a></li>"; 
                                
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getKTXSRegionNewest' target='_blank'>getKTXSRegionNewest</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getDream' target='_blank'>getDream</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKDauSo' target='_blank'>getTKDauSo</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKDuoiSo' target='_blank'>getTKDuoiSo</a></li>";
                                
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKBoKep' target='_blank'>getTKBoKep</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKTongChan' target='_blank'>getTKTongChan</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKTongLe' target='_blank'>getTKTongLe</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKBoChanLe' target='_blank'>getTKBoChanLe</a></li>";
                                
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKBoChanChan' target='_blank'>getTKBoChanChan</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKBoLeLe' target='_blank'>getTKBoLeLe</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKLotoGanCucDai' target='_blank'>getTKLotoGanCucDai</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKLotoDenKySoVoiKyGanNhat' target='_blank'>getTKLotoDenKySoVoiKyGanNhat</a></li>";
                                  
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKLotoDenKySoVoiKyCucDai' target='_blank'>getTKLotoDenKySoVoiKyCucDai</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKChuKyLoTo' target='_blank'>getTKChuKyLoTo</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTK12BoSoRaNhieu' target='_blank'>getTK12BoSoRaNhieu</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTK12BoSoRaIt' target='_blank'>getTK12BoSoRaIt</a></li>";
                                  echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKBoSoRaLienTiep' target='_blank'>getTKBoSoRaLienTiep</a></li>";
                                echo "</UL></td><td style='vertical-align:text-top;'>";
                                echo "<UL>";   
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKDauSoMoThuong' target='_blank'>getTKDauSoMoThuong</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKDuoiSoMoThuong' target='_blank'>getTKDuoiSoMoThuong</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKBoSoRaLienTiep' target='_blank'>getTKBoSoRaLienTiep</a></li>";
                                
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKDauSoMoThuong' target='_blank'>getTKDauSoMoThuong</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKDuoiSoMoThuong' target='_blank'>getTKDuoiSoMoThuong</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKBoSoMBGanTren10Ngay' target='_blank'>getTKBoSoMBGanTren10Ngay</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTKGiaiDacBietTheoNgay' target='_blank'>getTKGiaiDacBietTheoNgay</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getUserXoSo' target='_blank'>getUserXoSo</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getTaiKhoanChinh' target='_blank'>getTaiKhoanChinh</a></li>";
                                 echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=registerMember' target='_blank'>registerMember</a></li>";
                                 echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=updateUser' target='_blank'>updateUser</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=uploadAvatar' target='_blank'>uploadAvatar</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=postChat' target='_blank'>postChat</a></li>";             
                                 echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=registryNotice' target='_blank'>registryNotice</a></li>";             
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=postComment' target='_blank'>postComment</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getChatBox' target='_blank'>getChatBox</a></li>";
                                echo "<li><a href='".baseUrl()."kkt_api/xoso/XoSoAPI.php?function=getChatBoxFromID' target='_blank'>getChatBoxFromID</a></li>";
                                echo "</td>";
