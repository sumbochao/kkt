<?php
   ...
   function getCategory()
    {
        ...
        $sql = "SELECT id,name, image,count_game, create_date FROM vtc_game_store.g_category"; 
    ...
    function getPublisher()
    {
        ...
        $sql = "SELECT id,name, image,count_game,create_date FROM vtc_game_store.g_publisher "; 
        $querykey = "KEY" . md5($sql);
        $result = $meminstance->get($querykey);
        ...
        function getUserDownloadView($games,$os_type)
    {
        ...
        if($os_type==2)
        $sql ="SELECT d.game_id,d.user_id,d.username,d.avatar,g.count_android_download FROM g_user_download_view d inner join g_game g On d.game_id = g.id WHERE os_type = ".$os_type." AND game_id IN (".$str_ids.")";
        else
        $sql ="SELECT d.game_id,d.user_id,d.username,d.avatar,g.count_ios_download FROM g_user_download_view d inner join g_game g On d.game_id = g.id WHERE os_type = ".$os_type." AND game_id IN (".$str_ids.")";
        ...
        function getGameAPKHomeHot($limit, $page)
    {
        $meminstance = new Memcache();
        $meminstance->pconnect('localhost', 11211);
        
        $startRecord = ($page - 1) * $limit;    
        $sql = "SELECT  id,name,description,icon,version_android,version_os_android, 
    size_android,count_android_download,count_ios_download,count_android_view,count_review,mark,tags,create_date,category_id,publisher_id,publisher_name FROM vtc_game_store.g_game WHERE is_android = 1 AND is_hot = 1 AND status = 1 ORDER BY id DESC LIMIT " . $startRecord . ", " . $limit;
     ...
     function getUserDownload($game_id,$limit,$page)
    {
        ...
        $sql = "SELECT u.id,u.username,u.avatar FROM g_user u INNER JOIN g_user_download d ON u.id = d.user_id 
    ...
    function getGameAPKByCategoryHot($category_id,$limit, $page)
    {
        $meminstance = new Memcache();
        $meminstance->pconnect('localhost', 11211);
        ...
        $sql = "SELECT  id,name,description,icon,version_android,version_os_android, 
    size_android,count_android_download,count_ios_download,count_android_view,count_review,mark,tags,create_date,category_id,publisher_id,publisher_name FROM vtc_game_store.g_game WHERE is_android = 1 AND is_hot = 1 AND status = 1 AND category_id = ?  ORDER BY id DESC LIMIT " . $startRecord . ", " . $limit; 
    ...
    function getGameAPKByCategoryNew($category_id,$limit, $page)
    {
        $meminstance = new Memcache();
        $meminstance->pconnect('localhost', 11211);
        ...
        $connect = connectGameStoreDB();
        $sql = "SELECT  id,name,description,icon,version_android,version_os_android, 
    size_android,count_android_download,count_ios_download,count_android_view,count_review,mark,tags,create_date,category_id,publisher_id,publisher_name FROM vtc_game_store.g_game WHERE is_android = 1  AND status = 1 AND category_id = ?  ORDER BY id DESC LIMIT " . $startRecord . ", " . $limit;
        $querykey = "KEY" . md5($sql.$category_id);
        $resultCache = $meminstance->get($querykey);
    ...
    function getGameAPKByPublisherNew($publisher_id,$limit, $page)
    {
        $meminstance = new Memcache();
        $meminstance->pconnect('localhost', 11211);
        ...
        $sql = "SELECT  id,name,description,icon,version_android,version_os_android, 
    size_android,count_android_download,count_ios_download,count_android_view,count_review,mark,tags,create_date,category_id,publisher_id,publisher_name FROM vtc_game_store.g_game WHERE is_android = 1  AND status = 1 AND publisher_id = ?  ORDER BY id DESC LIMIT " . $startRecord . ", " . $limit;
     ...
     function getGameAPKByPublisherHot($publisher_id,$limit, $page)
    {
        $meminstance = new Memcache();
        $meminstance->pconnect('localhost', 11211);
        ...
        $startRecord = ($page - 1) * $limit;    
        $sql = "SELECT  id,name,description,icon,version_android,version_os_android, 
    size_android,count_android_download,count_ios_download,count_android_view,count_review,mark,tags,create_date,category_id,publisher_id,publisher_name FROM vtc_game_store.g_game WHERE is_android = 1 AND is_hot = 1  AND status = 1 AND publisher_id = ?  ORDER BY id DESC LIMIT " . $startRecord . ", " . $limit;
     ...
     function getGameAPKHomeNew($limit, $page)
    {
        $meminstance = new Memcache();
        $meminstance->pconnect('localhost', 11211);
        ...
        $startRecord = ($page - 1) * $limit;    
        $sql = "SELECT  id,name,description,icon,version_android,version_os_android, 
    size_android,count_android_download,count_ios_download,count_android_view,count_review,mark,tags,create_date,category_id,publisher_id,publisher_name FROM vtc_game_store.g_game WHERE is_android = 1 AND status = 1 ORDER BY id DESC LIMIT " . $startRecord . ", " . $limit;
     ...
     function getGameIOSHomeHot($limit, $page)
    {
        ...
        $startRecord = ($page - 1) * $limit;    
        $sql = "SELECT  id,name,description,icon,version_ios,version_os_ios, 
    size_ios,count_ios_download,count_android_download,count_ios_view,count_review,mark,tags,create_date,category_id,publisher_id,publisher_name FROM vtc_game_store.g_game WHERE is_ios = 1 AND is_hot = 1 AND status = 1 ORDER BY id DESC LIMIT  " . $startRecord . ", " . $limit;
     ...
     function getGameIOSHomeNew($limit, $page)
    {
        ...
        $startRecord = ($page - 1) * $limit;    
        $sql = "SELECT  id,name,description,icon,version_ios,version_os_ios, 
    size_ios,count_ios_download,count_android_download,count_ios_view,count_review,mark,tags,create_date,category_id,publisher_id,publisher_name FROM vtc_game_store.g_game WHERE is_ios = 1  AND status = 1 ORDER BY id DESC LIMIT  " . $startRecord . ", " . $limit;
     ...
     function getGameIOSByPublisherHot($publisher_id,$limit, $page)
    {
        ...
        $sql = "SELECT  id,name,description,icon,version_ios,version_os_ios, 
    size_ios,count_ios_download,count_android_download,count_ios_view,count_review,mark,tags,create_date,category_id,publisher_id,publisher_name FROM vtc_game_store.g_game WHERE is_ios = 1 AND is_hot = 1 AND status = 1 AND publisher_id = ?  ORDER BY id DESC LIMIT  " . $startRecord . ", " . $limit;; 
    ...
    function getGameIOSByPublisherNew($publisher_id,$limit, $page)
    {
        ...
        $sql = "SELECT  id,name,description,icon,version_ios,version_os_ios, 
    size_ios,count_ios_download,count_android_download,count_ios_view,count_review,mark,tags,create_date,category_id,publisher_id,publisher_name FROM vtc_game_store.g_game WHERE is_ios = 1 AND  status = 1 AND publisher_id = ?  ORDER BY id DESC LIMIT  " . $startRecord . ", " . $limit;
    ...
    function getGameIOSByCategoryNew($category_id,$limit, $page)
    {
        ...
        $sql = "SELECT  id,name,description,icon,version_ios,version_os_ios, 
    size_ios,count_ios_download,count_android_download,count_ios_view,count_review,mark,tags,create_date,category_id,publisher_id,publisher_name FROM vtc_game_store.g_game WHERE is_ios = 1 AND  status = 1 AND category_id = ?  ORDER BY id DESC LIMIT  " . $startRecord . ", " . $limit;
    ...
    function countGameAPKHotByPublisherID($publisher_id)
    {
        $meminstance = new Memcache();
        $meminstance->pconnect('localhost', 11211);
        
        $sql = "SELECT count(id) as sl FROM  vtc_game_store.g_game Where status = 1 & is_hot = 1 & is_android = 1  & publisher_id =  ".intval($publisher_id) ;
        $querykey = "KEY" . md5($sql);
    ...
    function countGameAPKByPublisherID($publisher_id)
    {
        $meminstance = new Memcache();
        $meminstance->pconnect('localhost', 11211);
        
        $sql = "SELECT count(id) as sl FROM  vtc_game_store.g_game Where status = 1 & is_android = 1  & publisher_id =  ".intval($publisher_id) ;
        $querykey = "KEY" . md5($sql);
     ...
     function countGameAPKByCategoryID($category_id)
    {
        $meminstance = new Memcache();
        $meminstance->pconnect('localhost', 11211);
        
        $sql = "SELECT count(id) as sl FROM  vtc_game_store.g_game Where status = 1 & is_android = 1  & category_id =  ".intval($category_id) ;
        $querykey = "KEY" . md5($sql);
    ...
    function countUserDownloadGame($game_id)
    {
     ...
     function countGameAPKHotByCategoryID($category_id)
    {
        $meminstance = new Memcache();
        $meminstance->pconnect('localhost', 11211);
        
        $sql = "SELECT count(id) as sl FROM  vtc_game_store.g_game Where status = 1 & is_android = 1 & is_hot=1 & category_id =  ".intval($category_id) ;
        $querykey = "KEY" . md5($sql);
    ...
    function countGameAPKHot()
    {
        $meminstance = new Memcache();
        $meminstance->pconnect('localhost', 11211);
        
        $sql = "SELECT count(id) as sl FROM  vtc_game_store.g_game Where status = 1 & is_android = 1 & is_hot=1 " ;
        $querykey = "KEY" . md5($sql);
    ...
    function getGameIOSByCategoryHot($category_id,$limit, $page)
    {
        ...
        $sql = "SELECT  id,name,description,icon,version_ios,version_os_ios, 
    size_ios,count_ios_download,count_android_download,count_ios_view,count_review,mark,tags,create_date,category_id,publisher_id,publisher_name FROM vtc_game_store.g_game WHERE is_ios = 1 AND is_hot = 1 AND status = 1 AND category_id = ?  ORDER BY id DESC LIMIT  " . $startRecord . ", " . $limit; 
    ...
    function getGameAPKDetail($game_id)
    {
        ...
        $sql = "SELECT  id,packet_id,publisher_id,name,room_name,room_password,description,content,icon,images,version_android,version_os_android,size_android,count_android_download,count_android_view,count_review,mark,tags,create_date,category_id,publisher_name,game_relate FROM vtc_game_store.g_game WHERE status = 1 AND id = ? " ;
      ...
      //  if (!$result) {
            ...
            $arrGameRelate = array();    
             if(!empty($game_relate))
             {
                  $game_relate = str_replace("[","",$game_relate);
                  $game_relate = str_replace("]","",$game_relate);
                  $arrGameRelate  = getGameRelate($game_relate);
             }
    ...
    function getGameIOSDetail($game_id)
    {
        ...
        $sql = "SELECT  id,bundle_id,publisher_id,name,room_name,room_password,description,content,images,icon,version_ios,version_os_ios,size_ios,count_ios_download,count_ios_view,count_review,mark,tags,create_date,category_id,publisher_name,game_relate FROM vtc_game_store.g_game WHERE is_ios = 1 AND status = 1 AND id = ? " ;
    ...
    function getCommentByNewsId($news_id,$limit, $page)
    {
        ...
        $sql = "SELECT  c.id,c.user_id,c.news_id,c.comment,DATE_FORMAT(c.create_date,'%h-%i %d-%m-%Y') as create_date,u.username,u.avatar,u.create_date as u_create_date FROM vtc_game_store.g_news_comment c INNER JOIN g_user u ON c.user_id = u.id Where c.news_id = ? ORDER BY c.id DESC LIMIT " . $startRecord . ", " . $limit;
    ...
    function getGiftCodeHome($limit, $page)
    {
        ...
        $sql = "  SELECT g.name,g.icon,g.count_review,g.mark,g.publisher_name,c.id,c.title,c.available_giftcode,c.total_giftcode,g.create_date FROM g_giftcode c 
         INNER JOIN g_game g ON c.game_id = g.id WHERE c.available_giftcode >0 ORDER BY c.id DESC LIMIT " . $startRecord . ", " . $limit;
    ...
    function getGiftCodeByCategory($category_id,$limit, $page)
    {
        ...
        $sql = "  SELECT g.name,g.icon,g.count_review,g.mark,g.publisher_name,c.id,c.title,c.available_giftcode,c.total_giftcode,g.create_date FROM g_giftcode c 
         INNER JOIN g_game g ON c.game_id = g.id WHERE c.available_giftcode >0 And c.category_id = ? ORDER BY c.id DESC LIMIT " . $startRecord . ", " . $limit;
    ...
    function getGiftCodeByPublisher($publisher_id,$limit, $page)
    {
        ...
        $sql = "  SELECT g.name,g.icon,g.count_review,g.mark,g.publisher_name,c.id,c.title,c.available_giftcode,c.total_giftcode,g.create_date FROM g_giftcode c 
         INNER JOIN g_game g ON c.game_id = g.id WHERE c.available_giftcode >0 And c.publisher_id = ? ORDER BY c.id DESC LIMIT " . $startRecord . ", " . $limit;
    ...
    function getGiftCodeDetailAPK($id)
    {
        ...
        $startRecord = ($page - 1) * $limit;    
        $sql = "SELECT g.id,g.packet_id,g.publisher_id,g.name,g.description,g.content,g.images,g.icon,g.version_android,g.version_os_android, 
    g.size_android,g.count_android_download,g.count_android_view,g.count_review,g.mark,g.tags,g.create_date,g.category_id,g.publisher_name,c.id as giftcode_id,c.title,c.available_giftcode,c.total_giftcode FROM g_giftcode c 
         INNER JOIN g_game g ON c.game_id = g.id WHERE  c.id = ? ";
         
        $querykey = "KEY" . md5($sql.$id);
        $resultCache = $meminstance->get($querykey);
    ...
    function getGiftCodeDetailIOS($id)
    {
        ...
        $meminstance->pconnect('localhost', 11211);
         ...
         $sql = "  SELECT g.id,g.publisher_id,g.name,g.description,g.content,g.images,g.icon,g.version_ios,g.version_os_ios, 
    g.size_ios,g.count_ios_download,g.count_ios_view,g.count_review,g.mark,g.tags,g.create_date,g.category_id,g.publisher_name,c.id as giftcode_id,c.title,c.available_giftcode,c.total_giftcode FROM g_giftcode c 
         INNER JOIN g_game g ON c.game_id = g.id WHERE  c.id = ? ";
     ...
     function getDiscussionByGameId($game_id,$limit, $page)
    {
        ...
        $sql = "SELECT d.id,d.user_id,d.content,d.image,d.image_width,d.image_height,d.create_date,d.count_like,d.count_comment,u.username,u.avatar,u.create_date as u_create_date FROM 
    ...
    function getDiscussionDetail($discussion_id,$page)
    {
        ...
        $sql = "SELECT d.id,d.user_id,d.game_id,d.content,d.image,d.image_width,d.image_height,d.count_like,d.count_comment,d.create_date,u.username,u.avatar,u.create_date as u_create_date FROM 
    ...
    function getUserIDCommentDiscussionOther($discussion_id,$user_ids)
    {
       ...
       // $meminstance->pconnect('localhost', 11211);
        ...
        $sql = "SELECT user_id FROM g_discusstion_comment WHERE discussion_id = ? AND user_id NOT IN (?) ";
        
        //$querykey = "KEY.getUserIDCommentDiscussionOther.".$user_ids.$discussion_id;
        //$resultCache = $meminstance->get($querykey);
        ...
        //if(!$resultCache){
            ...
            # creating the statement
            $q = $connect->prepare($sql);
            $q->execute(array($discussion_id,$user_ids));   
    ...
    function getDiscussionComment($discussion_id,$limit, $page)
    {
        ...
        $sql = "SELECT  c.id,c.discussion_id,c.user_id,c.comment,c.image,DATE_FORMAT(c.create_date,\"%h-%i %d-%m-%Y\") AS create_date,c.create_date as create_date_s,u.username,u.avatar,u.create_date as u_create_date FROM vtc_game_store.g_discusstion_comment c INNER JOIN g_user u ON c.user_id = u.id 
        WHERE c.discussion_id = ? ORDER BY c.id DESC LIMIT " . $startRecord . ", " . $limit;
        
        //$querykey = "KEY" . md5($sql.$discussion_id);
        $querykey = "KEY.comment.discussion." .$discussion_id.".".$page;
        $resultCache = $meminstance->get($querykey);
     ...
     function getGameReview($game_id,$limit, $page)
    {
        ...
        $startRecord = ($page - 1) * $limit;    
        $sql = "SELECT  r.id,r.game_id,r.user_id,r.content,r.mark,r.create_date,u.username,u.avatar,u.create_date as u_create_date FROM vtc_game_store.g_game_review r INNER JOIN g_user u ON r.user_id = u.id Where game_id = ? ORDER BY r.create_date DESC LIMIT " . $startRecord . ", " . $limit;
 ...
 ";
    ...
    function updateUserInfo($user_id,$username,$sex,$mobile,$birthday,$email,$facebook_id)
    {
    	$connect = connectGameStoreDB();
    ...
    {
        $sql = "SELECT id FROM g_giftcode  WHERE available_giftcode > 0 AND game_id = ? ORDER BY id DESC LIMIT 1";
        $meminstance = new Memcache();
        $meminstance->pconnect('localhost', 11211);
   ...
   function getAppHeaderStore($app_header,$app_client_id,$os_version,$imei){
    ...
    function getUserByAppClientId($app_client_id)
    {
        ...
        $sql = "SELECT id,app_client_id,username,password,email,mobile,avatar,sex,birthday,facebook_id,  
        is_ban_chat,is_ban_comment_new, create_date  FROM  vtc_game_store.g_user WHERE app_client_id = ?" ;
    ...
    function getUserById($id)
    {
        ...
        is_ban_chat,is_ban_comment_new, create_date  FROM  vtc_game_store.g_user WHERE id = ?" ;
    ...
    function getUserByUserName($username)
    {
        ...
        $sql = "SELECT id,app_client_id,username,password,email,mobile,avatar,sex,birthday,facebook_id, 
        is_ban_chat,is_ban_comment_new, create_date  FROM  vtc_game_store.g_user WHERE username = ?" ;
    ...
    function getAppHeader($app_header)
    {
        ...
        $sql = "SELECT id,app_header,os,version,link_update,update_info,chat_hostname,chat_port FROM vtc_game_store.g_app_header WHERE app_header = ? " ;
   ...
   function insertNoticeIOSUser($app_client_id,$device_token,$user_id,$username,$ip_address,$app_header)
    {
     ...
     function insertNoticeUser($app_client_id,$user_id,$device_token,$os_type,$app_header)
    {
        $count = 0;
        try{
            $connect = connectGameStoreDB();
            $sql = "INSERT INTO vtc_game_store.g_notice_user (app_client_id,user_id,device_token,os_type,create_date,app_header) 
                     VALUES (:app_client_id,:user_id,:device_token,:os_type,NOW(),:app_header)";
             
            # creating the statement
            $q = $connect->prepare($sql);
            $count = $q->execute(array(':app_client_id'=>$app_client_id,':user_id'=>$user_id,':device_token'=>$device_token,':os_type'=>$os_type,':app_header'=>$app_header));
    ...
    function insertNotice($object_id,$to_user,$content,$url,$type,$create_user)
    {
        $count = 0;
        try{
            $connect = connectGameStoreDB();
            $sql = "INSERT INTO vtc_game_store.g_notice (object_id,to_user,content, url, TYPE, STATUS, time_sent,create_date,create_user)
    VALUES (:object_id,:to_user,:content,:url,:type,'1',NOW(),NOW(),:create_user);";
             
            
            # creating the statement
            $q = $connect->prepare($sql);
            $count = $q->execute(array(':object_id'=>$object_id,':to_user'=>$to_user,':content'=>$content,':url'=>$url,':type'=>$type,':create_user'=>$create_user));
   ...
   function deleteDiscussion($id,$user_id)
    ...
    function uploadImageDiscussion($app_client_id,&$image,&$image_width,&$image_height){
         $uploaddir = '/upload/gamestore/discussion/';
        try {
  ...
  function searchKeywordIOS($keyword,$page,$limitItem) {
    ...
    for($i=0;$i<$num_row;$i++)
    {
      ...
      $arrGame[$i]["count_ios_view"] = java_values($docs[$i]->count_ios_view);
  ...
  function searchKeywordAndroid($keyword,$page,$limitItem) {
    ...
    for($i=0;$i<$num_row;$i++)
    {
      ...
      $arrGame[$i]["count_android_download"] = java_values($docs[$i]->count_ios_download);
      $arrGame[$i]["count_android_view"] = java_values($docs[$i]->count_ios_view);
      $arrGame[$i]["count_review"] = java_values($docs[$i]->count_review);
      $arrGame[$i]["is_hot"] = java_values($docs[$i]->is_hot);
