...
club_name_2,stadium,referee,coach_name_1,coach_name_2,result,result_1,STATUS,match_time,match_minute,sopcast_link From fb_match Where id =  ".$match_id." "; 
    ...
    {
        $match_id = intval($match_id);
        $sql = "SELECT id,image,video,create_date From fb_video Where match_id =  ".$match_id." "; 
    ...
    function checkAppHeaderBongDa($app_header)
    {
        ...
        $sql = "SELECT id,app_header,type_payment,os,isFree,VERSION,link_update,sms,admob_id,admob_id_tg FROM fb_app_header  WHERE app_header = '$app_header'" ;
   ...
   function insertAppTrackingBongDa($app_header,$app_client_id,$LOGS,$ip)
    ...
    function uploadAvatarFB($user_id){
         $uploaddir = '/upload/bongda/avatar/';
    ...
    function searchClub($keyword,$page,$limitItem) {
        ...
        for($i=0;$i<$num_row;$i++)
        {
          ...
          if($arrGame[$i]['logo']!="")
             $arrGame[$i]['logo'] = "http://kenhkiemtien.com/upload/bongda/club/".$time."/".$arrGame[$i]['logo'];
   ...
   function searchCup($keyword,$page,$limitItem) {
        ...
        for($i=0;$i<$num_row;$i++)
        {
          ...
          $time =    date("Y/md",strtotime($arrGame[$i]["create_date"]));
          if($arrGame[$i]['logo']!="")
             $arrGame[$i]['logo'] = "http://kenhkiemtien.com/upload/bongda/cup/".$time."/".$arrGame[$i]['logo'];
  ...
  function searchCoach($keyword,$page,$limitItem) {
        ...
        for($i=0;$i<$num_row;$i++)
        {
          ...
          $time =    date("Y/md",strtotime($arrGame[$i]["create_date"]));
          if($arrGame[$i]['avatar']!="")
             $arrGame[$i]['avatar'] = "http://kenhkiemtien.com/upload/bongda/coach/".$time."/".$arrGame[$i]['avatar'];
  ...
  function searchFootballer($keyword,$page,$limitItem) {
        ...
        for($i=0;$i<$num_row;$i++)
        {
          ...
          $time =    date("Y/md",strtotime($arrGame[$i]["create_date"]));
          if($arrGame[$i]['avatar']!="")
             $arrGame[$i]['avatar'] = "http://kenhkiemtien.com/upload/bongda/footballer/".$time."/".$arrGame[$i]['avatar'];
   ...
   function searchNews($keyword,$page,$limitItem) {
        ...
        for($i=0;$i<$num_row;$i++)
        {
          ...
          $time =    date("Y/md",strtotime($arrGame[$i]["create_date"]));
          if($arrGame[$i]['image']!="")
             $arrGame[$i]['image'] = "http://kenhkiemtien.com/upload/bongda/news/".$time."/".$arrGame[$i]['image'];
  ...
  function searchVideo($keyword,$page,$limitItem) {
        ...
        for($i=0;$i<$num_row;$i++)
        {
          ...
          $time =    date("Y/md",strtotime($arrGame[$i]["create_date"]));
          if($arrGame[$i]['image']!="")
             $arrGame[$i]['image'] = "http://kenhkiemtien.com/upload/bongda/video/".$time."/".$arrGame[$i]['image'];
