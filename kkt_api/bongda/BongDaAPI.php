<?php
  ...
  switch ($action) {
        ...
        case "postClubFavorite" :{
                ...
                $dataLog = createDataLog ("postClubFavorite", $arrPara, "" );
                $ip = getRealIpAddr ();
                insertAppTrackingBongDa(0, $app_client_id, $dataLog, $ip );
        ...
        case "removeClubFavorite" :{
                ...
                $arrPara = array ("app_client_id"=>$app_client_id,"club_id"=>$club_id);
                $dataLog = createDataLog ("removeClubFavorite", $arrPara, "" );
                $ip = getRealIpAddr ();
                insertAppTrackingBongDa(0, $app_client_id, $dataLog, $ip );
        ...
        case "postCupFavorite" :{
                ...
                $dataLog = createDataLog ("postCupFavorite", $arrPara, "" );
                $ip = getRealIpAddr ();
                insertAppTrackingBongDa(0, $app_client_id, $dataLog, $ip );
         ...
         case "postMatchFavorite" :{
                ...
                $dataLog = createDataLog ("postMatchFavorite", $arrPara, "" );
                $ip = getRealIpAddr ();
                insertAppTrackingBongDa(0, $app_client_id, $dataLog, $ip );
         ...
         case "removeCupFavorite" :{
                ...
                $arrPara = array ("app_client_id"=>$app_client_id,"cup_id"=>$cup_id);
                $dataLog = createDataLog ("removeCupFavorite", $arrPara, "" );
                $ip = getRealIpAddr ();
                insertAppTrackingBongDa(0, $app_client_id, $dataLog, $ip );
          ...
          case "removeMatchFavorite" :{
                ...
                $arrPara = array ("app_client_id"=>$app_client_id,"match_id"=>$match_id);
                $dataLog = createDataLog ("removeMatchFavorite", $arrPara, "" );
                $ip = getRealIpAddr ();
                insertAppTrackingBongDa(0, $app_client_id, $dataLog, $ip );
             ...
             default :
        {
            ...
            if (! empty ( $function )) {
                ...
                $url_api = "http://kenhkiemtien.com/kkt_api/bongda/BongDaAPI.php";
