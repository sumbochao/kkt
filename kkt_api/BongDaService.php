...
// Cup code
    $arrCupCodeMAP = array("ANH"=>"ANHA","ANHA"=>"ANHA","AN"=>"ANHA","ANA"=>"ANHA","ANHB"=>"ANHA","ANH2"=>"ANHA"
        ...
        ,"ITA"=>"ITA","ITALIA"=>"ITA","ITAA"=>"ITA","ITAL"=>"ITA","ITALI"=>"ITA","Y"=>"ITA","ITB"=>"ITB","IT2"=>"ITB","Y2"=>"ITB","YB"=>"ITB"
        ,"C1"=>"C1","C2"=>"C2","UEFA"=>"C2"
        ,"VNA"=>"VNA","VIETNAM"=>"VNA","VIET"=>"VNA","VN"=>"VNA"
        ,"U20"=>"W20","20"=>"W20","fifau20worldcup"=>"W20","fifau20worldcup"=>"W20","U2O"=>"W20"
        ,"seagem"=>"SEA","seagame"=>"SEA"
        ,"CAM"=>"CAM23","PHI"=>"PHI23"
        ,"NHAT"=>"NHATA","NHA"=>"NHATA");
...
// Tach Action Tu SMS    
       // $sms ="BD KQ BAR";
        ...
        $huongdanTl = "Chua co TL".$ktXuongDong
        ."KQ Soan:BD MaGiai".$ktXuongDong
        ."TyLe:TL MaGiai".$ktXuongDong
