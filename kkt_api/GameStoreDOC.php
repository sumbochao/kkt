  ...
  class GameStoreDOC
{
    ...
    function outLineGetCategory(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getCategory' target='_blank'>getCategory</a></span>";
     ...
     function outLineGetPublisher(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getPublisher' target='_blank'>getPublisher</a></span>";
     ...
     function outLineGetGameAPKHomeHot(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameAPKHomeHot&page=1' target='_blank'>getGameAPKHomeHot</a></span>";
    ...
    function outLineGetGameAPKHomeNew(){
        ...
        echo "<LI>page: số page</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameAPKHomeNew&page=1' target='_blank'>getGameAPKHomeNew</a></span>";
    ...
    function outLineGameAPKByCategoryHot(){
        ...
        echo "<LI>page: số page</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameAPKByCategoryHot&category_id=1&page=1' target='_blank'>getGameAPKByCategoryHot</a></span>";
     ...
     function outLineGetGameAPKByCategoryNew(){
        ...
        echo "<LI>page: số page</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameAPKByCategoryNew&category_id=1&page=1' target='_blank'>getGameAPKByCategoryNew</a></span>";
    ...
    function outLineGetGameAPKByPublisherHot(){
        ...
        echo "<LI>page: số page</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameAPKByPublisherHot&publisher_id=1&page=1' target='_blank'>getGameAPKByPublisherHot</a></span>";
     }
     ...
     function outLineGetGameAPKByPublisherNew(){
        ...
        echo "<LI>page: số page</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameAPKByPublisherNew&publisher_id=1&page=1' target='_blank'>getGameAPKByPublisherNew</a></span>";
     }
     ...
     function outLineGetGameIOSHomeNew(){
        ...
        echo "<LI>page: số page</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameIOSHomeNew&page=1' target='_blank'>getGameIOSHomeNew</a></span>";
    }
     ...
     function outLineGetGameIOSHomeHot(){
        ...
        echo "<LI>page: số page</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameIOSHomeHot&page=1' target='_blank'>getGameIOSHomeHot</a></span>";
    }
    ...
    function outLineGetGameIOSByCategoryHot(){
        ...
        echo "<LI>page: số page</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameIOSByCategoryHot&category_id=1&page=1' target='_blank'>getGameIOSByCategoryHot</a></span>";
    }
    ...
    function outLineGetGameIOSByCategoryNew(){
        ...
        echo "<LI>page: số page</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameIOSByCategoryNew&category_id=1&page=1' target='_blank'>getGameIOSByCategoryNew</a></span>";
    }
    ...
    function outLineGetGameIOSByPublisherNew(){
        ...
        echo "<LI>page: số page</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameIOSByPublisherNew&publisher_id=1&page=1' target='_blank'>getGameIOSByPublisherNew</a></span>";
    }
    ...
    function outLineGetGameIOSByPublisherHot(){
        ...
        echo "<LI>page: số page</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameIOSByPublisherHot&publisher_id=1&page=1' target='_blank'>getGameIOSByPublisherHot</a></span>";
    }
    ...
    function outLineGetGameAPKDetail(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameAPKDetail&id=1' target='_blank'>getGameAPKDetail</a></span>";
    }
    ...
    function outLineGetGameIOSDetail(){
        ...
        echo "<LI>id: id game</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameIOSDetail&id=3' target='_blank'>getGameIOSDetail</a></span>";
    }
     ...
     function outLineGetNewsHome(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getNewsHome&page=1' target='_blank'>getNewsHome</a></span>";
    }
    ...
    function outLineGetNewsByCategory(){
        ...
        echo "<LI>page: số thứ tự trang</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getNewsByCategory&category_id=1&page=1' target='_blank'>getNewsByCategory</a></span>";
    }
    ...
    function outLineGetNewsByPublisher(){
        ...
        echo "<LI>publiser_id: id danh mục</LI>";
        echo "<LI>page: số thứ tự trang</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getNewsByPublisher&publiser_id=1&page=1' target='_blank'>getNewsByPublisher</a></span>";
    }
    ...
    function outLineGetNewsByGame(){
        ...
        echo "<LI>page: số thứ tự trang</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getNewsByGame&game_id=1&page=1' target='_blank'>getNewsByGame</a></span>";
    }
    ...
    function outLineGetNewsDetail(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getNewsDetail&id=1' target='_blank'>getNewsDetail</a></span>";
    }
    ...
    function outLineGetGiftCodeHome(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGiftCodeHome&page=1' target='_blank'>getGiftCodeHome</a></span>";
    }
    ...
    function outLineGetGiftCodeByCategory(){
        ...
        echo "<LI>page: số trang</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGiftCodeByCategory&category_id=1&page=1' target='_blank'>getGiftCodeByCategory</a></span>";
    }
    ...
    function outLineGetGiftCodeByPublisher(){
        ...
        echo "<LI>page: số trang</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGiftCodeByPublisher&publisher_id=1&page=1' target='_blank'>getGiftCodeByPublisher</a></span>";
    }
    ...
    function outLineGetGiftCodeByGameId(){
        ...
        echo "<LI>page: số trang</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGiftCodeByGameId&game_id=1&page=1' target='_blank'>getGiftCodeByGameId</a></span>";
    }
    ...
    function outLineGetCommentByNewsId(){
        ...
        echo "<LI>page: số trang</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getCommentByNewsId&news_id=1&page=1' target='_blank'>getCommentByNewsId</a></span>";
    }
    ...
    function outLineGetDiscussionByGameId(){
        ...
        echo "<LI>page: số trang</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getDiscussionByGameId&game_id=1&page=1' target='_blank'>getDiscussionByGameId</a></span>";
    }
     ...
     function outLineGetDiscussionDetail(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getDiscussionDetail&id=1&page=1' target='_blank'>getDiscussionDetail</a></span>";
    }
     ...
     function outLineGetDiscussionComment(){
        ...
        echo "<LI>id: id của thảo luật</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getDiscussionComment&discussion_id=1&page=1' target='_blank'>getDiscussionComment</a></span>";
    }
     ...
     function outLineGetGameReview(){
        ...
        echo "<LI>page: số trang</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameReview&game_id=1&page=1' target='_blank'>getGameReview</a></span>";
    }
    ...
    function outLinePostReviewGame(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=postReviewGame&game_id=1&user_id=1&mark=5&content=Game hay&create_user=thangtt' target='_blank'>postReviewGame</a></span>";
    }
    ...
    function outLinePostCommentNews(){
        ...
        echo "<LI><strong>Kết quả</strong>: 0: Thành công, 1: Thiếu tham số, 2: Post không thành công</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=postCommentNews&news_id=1&user_id=1&comment=Game hay&create_user=thangtt' target='_blank'>postCommentNews</a></span>";
    }
     ...
     function outLinePostCommentDiscussion(){
        ...
        echo "<LI><strong>Kết quả</strong>: 0: Thành công, 1: Thiếu tham số, 2: Post không thành công</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=postCommentDiscussion&discussion_id=1&user_id=1&comment=Game hay&image=abc.jpg&create_user=thangtt' target='_blank'>postCommentDiscussion</a></span>";
    }
     ...
     function outLinePostDiscussion(){
        ...
        echo "<LI><strong>Kết quả</strong>: 0: Thành công, 1: Thiếu tham số, 2: Post không thành công</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=postDiscussion&game_id=1&user_id=1&content=Game hay&image=abc.jpg&create_user=thangtt' target='_blank'>postDiscussion</a></span>";
    }
    ...
    function outLineGetBannerIOSTopHot(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getBannerIOSTopHot' target='_blank'>getBannerIOSTopHot</a></span>";
    }
    ...
    function outLineGetBannerIOSTopNew(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getBannerIOSTopNew' target='_blank'>getBannerIOSTopNew</a></span>";
    }
    ...
    function outLineGetBannerAndroidTopHot(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getBannerAndroidTopHot' target='_blank'>getBannerAndroidTopHot</a></span>";
    }
    ...
    function outLineGetBannerAndroidTopNew(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getBannerAndroidTopNew' target='_blank'>getBannerAndroidTopHot</a></span>";
    }
    ...
    function outLineGetGiftCodeDetailIOS(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGiftCodeDetailIOS&id=1' target='_blank'>getGiftCodeDetailIOS</a></span>";
    }
    ...
    function outLineGetGiftCodeDetailAPK(){
        ...
        echo "<LI>id: id gift code</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGiftCodeDetailAPK&id=1' target='_blank'>getGiftCodeDetailAPK</a></span>";
    }
    ...
    function outLineAddCountAndroidDownloadGame(){
            ...
            echo "</UL>";
            echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=addCountAndroidDownloadGame&id=1' target='_blank'>addCountAndroidDownloadGame</a></span>";
    }
    ...
    function outLineAddCountIOSDownloadGame(){
            ...
            echo "<LI>id: id của game</LI>";
            echo "</UL>";
            echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=addCountIOSDownloadGame&id=1' target='_blank'>addCountIOSDownloadGame</a></span>";
    }
    ...
    function outLineGetGiftCodeStoreAvailable(){
            ...
            echo "</UL>";
            echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGiftCodeStoreAvailable&giftcode_id=1&user_id=1' target='_blank'>getGiftCodeStoreAvailable</a></span>";
    }
    ...
    function outLineSendGiftCodeStoreToMember(){
            ...
            echo "</UL>";
            echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=sendGiftCodeStoreToMember&giftcode_id=1&user_id=1&code_id=121' target='_blank'>sendGiftCodeStoreToMember</a></span>";
    }
    ...
    function outLineGetContactGame(){
            ...
            echo "<LI>id: id của game</LI>";
            echo "</UL>";
            echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getContactGame&id=1' target='_blank'>getContactGame</a></span>";
    }
    ...
    function outLineGetAppHeader(){
            ...
            echo "</UL>";
            echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getAppHeader&app_header=APPSTORE_IOS&app_client_id=0&imei=&os_version=7.0' target='_blank'>getAppHeader</a></span>";
    }
    ...
    function outLineGetUserById(){
            ...
            echo "</UL>";
            echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getUserById&id=1' target='_blank'>getUserById</a></span>";
    }
    ...
    function outLineGetUserByUserName(){
            ...
            echo "</UL>";
            echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getUserByUserName&username=thangtt' target='_blank'>getUserByUserName</a></span>";
    }
    ...
    function outLineUpdateUserInfo(){
    	...
    	echo "<LI>username: Tên dang nhap của user method: POST</LI>";
    	...
    	echo "</UL>";
    	echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=updateUserInfo' target='_blank'>updateUserInfo</a></span>";
    }
    ...
    function outLineUploadAvatar(){
    	...
    	echo "</UL>";
    	echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=uploadAvatar' target='_blank'>uploadAvatar</a></span>";
    }
    ...
    function outLineSearchKeywordIOS(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=searchKeywordIOS&keyword=ban sung' target='_blank'>searchKeywordIOS</a></span>";
    }
    ...
    function outLineSearchKeywordAndroid(){
        ...
        echo "<LI>Kết quả: Danh sánh games và Tổng số game tìm thấy</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=searchKeywordAndroid&keyword=ban sung' target='_blank'>searchKeywordAndroid</a></span>";
    }
    ...
    function outLineGetKeywordAndroidRecommend(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getKeywordAndroidRecommend' target='_blank'>getKeywordAndroidRecommend</a></span>";
    }
    ...
    function outLineGetKeywordIOSRecommend(){
        ...
        echo "<LI>Kết quả: Danh sánh từ khóa đề cử</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getKeywordIOSRecommend' target='_blank'>getKeywordIOSRecommend</a></span>";
    }
    ...
    function outLineSearchKeywordRecommentAndroid(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=searchKeywordRecommentAndroid&keyword=ban sun' target='_blank'>searchKeywordRecommentAndroid</a></span>";
    }
    ...
    function outLineSearchKeywordRecommentIOS(){
        ...
        echo "<LI>Kết quả: Danh sánh game</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=searchKeywordRecommentIOS&keyword=ban sun' target='_blank'>searchKeywordRecommentIOS</a></span>";
    }
    ...
    function outLineDownloadGameIOS(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=downloadGameIOS&game_id=1&user_id=1' target='_blank'>downloadGameIOS</a></span>";
    }
    ...
    function outLineDownloadGameAndroid(){
        ...
        echo "<LI>Kết quả: trả về gồm 2 phần result và link tải<br>Result:1 Thiếu tham số, 0: success</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=downloadGameAndroid&game_id=1&user_id=1' target='_blank'>downloadGameAndroid</a></span>";
    }
    ...
    function outLineGetUserDownload(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getUserDownload&game_id=1' target='_blank'>getUserDownload</a></span>";
    }
    ...
    function outLineInsertLikeNews(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=likeNews&user_id=1&news_id=1' target='_blank'>likeNews</a></span>";
    }
     ...
     function outLineDisLikeNews(){
        ...
        echo "<LI>Kết quả: 1: Thieu tham so; 0: Success</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=disLikeNews&user_id=1&news_id=1' target='_blank'>disLikeNews</a></span>";
    }
    ...
    function outLineInsertLikeDiscussion(){
        ...
        echo "<LI>Kết quả: 1: Thieu tham so; 0: Success</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=likeDiscussion&user_id=1&discussion_id=1' target='_blank'>insertLikeDiscussion</a></span>";
    }
    ...
    function outLineDisLikeDiscussion(){
        ...
        echo "<LI>Kết quả: 1: Thieu tham so; 0: Success</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=disLikeDiscussion&user_id=1&discussion_id=1' target='_blank'>disLikeDiscussion</a></span>";
    }
    ...
    function outLineGetRoomInfo(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getRoomInfo&id=1' target='_blank'>getRoomInfo</a></span>";
    }
    ...
    function outLineGetVersionStore(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getVersionStore&app_header=APPSTORE_IOS' target='_blank'>getVersionStore</a></span>";
    }
    ...
    function outLineRegistryNoticeIOS(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=registryNoticeIOS&app_header=APPSTORE_IOS&app_client_id=123&device_token=123&user_id=1' target='_blank'>registryNoticeIOS</a></span>";
    }
    ...
    function outLineRegistryNotice(){
        ...
        echo "<LI>Kết quả: 0: thành công, 1 : thiếu tham số, 2 : có lỗi insert</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=registryNotice&app_header=APPSTORE_ANDROID&app_client_id=123&device_token=123&os_type=2&user_id=1' target='_blank'>registryNotice</a></span>";
    }
     ...
     function outLineGetGameDownloadByUser(){
        ...
        echo "</UL>";
            echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameDownloadByUser&user_id=1' target='_blank'>getGameDownloadByUser</a></span>";
    }
    ...
    function outLineGetUsernameById(){
        ...
        echo "</UL>";
            echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getUsernameById&id=1' target='_blank'>getUsernameById</a></span>";
    }
     ...
     function outLineGetBackgroundUser(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getBackgroundUser' target='_blank'>getBackgroundUser</a></span>";
    }
    ...
    function outLinePushNotifyChatOffline(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=pushNotifyChatOffline&to_userId=1&from_userId=2' target='_blank'>pushNotifyChatOffline</a></span>";
    }
     ...
     function outLineDeleteDiscussion(){
        ...
        echo "<LI>method: post</LI>";
        echo "<LI>user_id: id cua user dc gui thảo luận</LI>";
        echo "<LI>discussion_id: id cua thảo luận</LI>";
        echo "<LI>Kết quả: 0: thanh cong, 1 thieu tham so, 2 khong thanh cong</LI>";
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=deleteDiscussion&user_id=1&discussion_id=2' target='_blank'>deleteDiscussion</a></span>";
    }
     ...
     function outLineGetGameHadEvent(){
        ...
        echo "</UL>";
        echo "<span>Ví dụ: <a href='http://kenhkiemtien.com/kkt_api/GameStoreAPI.php?action=getGameHadEvent' target='_blank'>getGameHadEvent</a></span>";
    }
}
?>