...
?>
Upload File.<br>
<form action="http://kenhkiemtien.com/kkt_api/audio/AudioAPI.php?action=uploadAvatar&user_id=1&&app_id=16&app_client_id=8&token=T0dGaE9HUTBNMkpsT0RGaE9UQTROVE0zTkRsallXTmlaakE1TXpBNU16VXhOamd4TmpnPQ==" method="post" enctype="multipart/form-data" ><br>
...
<br>
Add User<br>
<form action="http://kenhkiemtien.com/kkt_api/audio/AudioAPI.php?action=registerMember&app_client_id=0" method="post" ><br>
...
<br>
Post Comment<br>
<form action="http://kenhkiemtien.com/kkt_api/audio/AudioAPI.php?action=postCommentAudio&app_client_id=123" method="post" ><br>
